      ...
      <div class="row">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php
				...
				$con=new mysqli('localhost', 'root', '', 'crypto');
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <?php
                echo "<h3>4<sup style='font-size: 20px'></sup></h3>";
              ?>
          
              <p>No of Visitors Today</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              ...
              <p>New Registration : Current Month</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <p>Inactive Customers: Current Month</p>
            </div>
            <div class="icon">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Yearly Transaction Report</h3>
...
<?php
  ...
  for( $m = 1; $m <= 12; $m++ ) {
    ...
    array_push($ontime, $oquery->num_rows+rand(50,100));

    $sql = "SELECT * FROM attendance WHERE MONTH(date) = '$m' AND status = 0 $and";
    $lquery = $conn->query($sql);
    array_push($late, $lquery->num_rows+rand(40,90));
